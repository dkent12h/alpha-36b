...
// api/yahoo-html/quote/[symbol].js
async function onRequest(context) {
  const { request, params } = context;
  let symbol = params.symbol;
  if (!symbol) {
    const url = new URL(request.url);
    const match2 = url.pathname.match(/\/api\/yahoo-html\/quote\/([^/]+)/);
    if (match2 && match2[1]) {
      symbol = match2[1];
    }
  }
...
// ../.wrangler/tmp/pages-RyVx9d/functionsRoutes-0.2005873503005322.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-cSfSYo/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-cSfSYo/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.220041253868842.mjs.map
